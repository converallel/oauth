...
class AccessTokensFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'access_tokens_ibfk_1' => ['type' => 'foreign', 'columns' => ['client_id'], 'references' => ['clients', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
            'access_tokens_ibfk_2' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => '074df122-dc6d-4e14-a9eb-c6b206a0f85a',
                'user_id' => 1,
                'client_id' => 1,
                'name' => 'Lorem ipsum dolor sit amet',
                'revoked' => 1,
                'created_at' => 1547839881,
                'modified_at' => 1547839881,
                'expires_at' => 1547839881
            ],
        ];
        parent::init();
    }
